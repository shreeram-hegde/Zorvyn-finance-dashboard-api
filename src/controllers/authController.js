...
// Username check is handled by the DB's UNIQUE constraint, 
// but catching it here to give the client a readable error message.
...
const updateRecord = (req, res) => {
    try {
        const validatedData = recordSchema.parse(req.body); // Re-use Zod schema!
